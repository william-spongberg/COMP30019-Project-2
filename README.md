...
4. Pause Menu: I designed and implemented an intuitive pause menu, giving players control over their gameplay. This menu includes options to resume, restart, or access additional settings, contributing to a more user-friendly experience.
