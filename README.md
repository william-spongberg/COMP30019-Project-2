...
*User Evaluation, Audio, UI, Elevating system*

1. Elevator System for Scene Transitions: I designed and implemented an elevator system that enables seamless transitions between different scenes within the game. This feature adds an interactive and immersive experience, allowing players to move fluidly between various game environments.
2. Randomized Office Spaces: To provide a randomised office space to give a sense of eeriness, I  helped in creating multiple versions of the office space to spawn them randomly in the game environment. 
3. Start Scene for Game Introduction: I developed a start scene to introduce players to the game, giving the starting point to the player. 
4. Pause and Settings Menu: I designed and implemented an intuitive pause menu, giving players control over their gameplay. This menu includes options to resume, restart, or access additional settings like changing FOV and mouse sensitivity, contributing to a more user-friendly experience. 
5. Comprehensive Audio Design: I added audio elements to the game, including immersive background music, realistic footsteps, elevator sounds, and shooting effects. These audio elements are crucial in creating an engaging and lifelike game environment, enhancing player immersion and the overall sensory experience.
6. User Evaluation Form and Evaluation Plan: Understanding the importance of user feedback, I created a comprehensive evaluation form along with an evaluation plan. This plan ensures structured and actionable insights from users, allowing for continuous improvement based on real user experiences.
